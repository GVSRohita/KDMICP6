...
reviews_df = pd.read_csv('/Users/GowthamYesG/Desktop/KDM/Tutorial 6 Source Code/netflix_titles.csv', error_bad_lines=False)
...
t1 = time.time()
reviews_df['tokenized_reviews'] = reviews_df['description'].apply(apply_all)
t2 = time.time()
...
print("This output shows the Topic-Words matrix for the 5 topics created and the 4 words within each topic")
for topic in topics:
    print(topic)
